...
export const PRICELISTGRAPH = [
    {
        title:'ROLEX DAYTONA',
        refNum:'Ref. 116520',
        picture:'/images/1-rolex-graph.png'
    },
    {
        title:'ROLEX SEADWELLER',
        refNum:'Ref. 16600',
        picture:'/images/2-rolex-graph.png'
    },
    {
        title:'ROLEX SUBMARINER',
        refNum:'Ref. 116520',
        picture:'/images/3-rolex-graph.png'
    },
    {
        title:'ROLEX SEADWELLER',
        refNum:'Ref. 16600',
        picture:'/images/4-rolex-graph.png'
    },
    
]

export const POINTROLEX = [
    {
        picture:'/images/1-point.png',
        reason:'Reason [1]',
        title:'Professional Appraisal Staff',
        desc:'At Jewel Cafe, our professional staff will carefully appraise your item.Taking into account of latest price data and market prices, we appraise with confidence and strive every day to offer the best price to satisfy our customers.',
    },
    {
        picture:'/images/2-point.png',
        reason:'Reason [2]',
        title:'Unique worldwide sales channels',
        desc:'Jewel Café has many operating stores oversea. By utilizing our domestic and international network to sell the items, we are able to offer even higher pricesfor the product we purchase.',
    },
    {
        picture:'/images/3-point.png',
        reason:'Reason [3]',
        title:'250 direct-managed store worldwide',
        desc:'Jewel Café has more than 250 directly operated stores worldwideand has been used by more than 3 million customers to date. We will continue to strive to keep the faith of our customers.',
    },
    {
        picture:'/images/4-point.png',
        reason:'Reason [4]',
        title:'Various benefits available',
        desc:'At Jewel Cafe, we offer a variety of special offers that can be used during your visit, our loyal customers are also overjoyed with these benefits. T-point and jewelry cleaning service are very popular among our customers!',
    },
    {
        picture:'/images/5-point.png',
        reason:'Reason [5]',
        title:'Easy and convenient store location',
        desc:'Jewel Café have stores operating at convenient locations such as large shopping mall and shoppingstreet at station front. We always aim to create a comfortable space which you can casually stop by during your grocery shopping.',
    },
...
export const ROLEXPRICETABLE = [
    {
        brand:'Rolex',
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-1.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-2.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-3.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-4.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-5.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-6.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-7.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-8.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-9.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    },
    {
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-10.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-11.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
    ...
    ,{
        ...
        model:'Daytona',
        modelNum:'116520',
        graph:'/images/Graph/graph-12.jpg',
        picture:'/images/smallrolex.png',
        desc1:'Jewel Cafe',
        desc2:'Latest market price',
        price:'RM78,200.00',
  ...
  export const OUTLET = [
    {
        ...
        state:'Kuala Lumpur',
        link:'https://jewel-cafe.my/shops/aeon-au2/',
    },
    {
        ...
        state:'Kuala Lumpur',
        link:'https://jewel-cafe.my/shops/aeon-taman-maluri/',
    },
   
    {
        ...
        state:'Selangor',
        link:'https://jewel-cafe.my/shops/aeon-taman-equine/',
    },
    {
        ...
        state:'Selangor',
        link:'https://jewel-cafe.my/shops/tropicana-gardens/',
    },
    {
        ...
        state:'Selangor',
        link:'https://jewel-cafe.my/shops/aeon-bukit-tinggi/',
    },
    {
        name:'AEON Shah Alam',
        address:'Lot G36, Ground Floor, Aeon Mall Shah Alam Shopping Centre, Jalan Akuatik 13/64, Seksyen 13, 40100 Shah Alam, Selangor',
        tel:'TEL 03-5524 3313',
        state:'Selangor',
        link:'https://jewel-cafe.my/shops/aeon-shah-alam/',
    },
    {
        name:'Central i-City',
        address:'Lot L1-44, Central i-City Shopping Centre, No. 1, Persiaran Multimedia, i-City, Seksyen 7, 40000 Shah Alam, Selangor.',
        tel:'TEL 03-5524 2013',
        state:'Selangor',
        link:'',
    },
    {
        ...
        tel:'TEL 04-536 0331',
        state:'Penang',
        link:'https://jewel-cafe.my/shops/aeon-bukit-mertajam/',
    },
    {
        name:'Gurney Paragon',
        ...
        tel:'TEL 04-227 9041',
        state:'Penang',
        link:'https://jewel-cafe.my/shops/gurney-paragon/',
    },
    {
        name:'Paradigm Mall',
        ...
        tel:'TEL 07-2321 567',
        state:'Johor',
        link:'https://jewel-cafe.my/shops/paradigm-mall/',
    },
    {
        ...
        tel:'TEL 07-3500 321',
        state:'Johor',
        link:'https://jewel-cafe.my/shops/toppen/',
    },
  ]